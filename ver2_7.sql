...
--
-- Name: lab_in_criteria; Type: TABLE; Schema: public; Owner: master
--

CREATE TABLE public.lab_in_criteria (
    lab_for_criteria_id integer NOT NULL,
    lab_id integer,
    test_id integer,
    selected_parameter text,
    weight double precision,
    growth_course boolean,
    cut_level double precision
);


ALTER TABLE public.lab_in_criteria OWNER TO master;

--
-- Name: lab_in_criteria_lab_for_criteria_id_seq; Type: SEQUENCE; Schema: public; Owner: master
--

CREATE SEQUENCE public.lab_in_criteria_lab_for_criteria_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.lab_in_criteria_lab_for_criteria_id_seq OWNER TO master;

--
-- Name: lab_in_criteria_lab_for_criteria_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: master
--

ALTER SEQUENCE public.lab_in_criteria_lab_for_criteria_id_seq OWNED BY public.lab_in_criteria.lab_for_criteria_id;
...
--
-- Name: user_pvk_profession_result; Type: TABLE; Schema: public; Owner: master
--

CREATE TABLE public.user_pvk_profession_result (
    id integer NOT NULL,
    respondent_id integer,
    pvk_id integer,
    profession integer,
...
ALTER TABLE public.user_pvk_profession_result OWNER TO master;

--
-- Name: user_pvk_profession_result_id_seq; Type: SEQUENCE; Schema: public; Owner: master
--

CREATE SEQUENCE public.user_pvk_profession_result_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.user_pvk_profession_result_id_seq OWNER TO master;

--
-- Name: user_pvk_profession_result_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: master
--

ALTER SEQUENCE public.user_pvk_profession_result_id_seq OWNED BY public.user_pvk_profession_result.id;
...
--
-- Name: lab_in_criteria lab_for_criteria_id; Type: DEFAULT; Schema: public; Owner: master
--

ALTER TABLE ONLY public.lab_in_criteria ALTER COLUMN lab_for_criteria_id SET DEFAULT nextval('public.lab_in_criteria_lab_for_criteria_id_seq'::regclass);
...
--
-- Name: user_pvk_profession_result id; Type: DEFAULT; Schema: public; Owner: master
--

ALTER TABLE ONLY public.user_pvk_profession_result ALTER COLUMN id SET DEFAULT nextval('public.user_pvk_profession_result_id_seq'::regclass);
...
COPY public.criteria (criteria_id, criteria_name, labs_for_criteria, criteria_weight) FROM stdin;
\.
...
--
-- Data for Name: lab_in_criteria; Type: TABLE DATA; Schema: public; Owner: master
--

COPY public.lab_in_criteria (lab_for_criteria_id, lab_id, test_id, selected_parameter, weight, growth_course, cut_level) FROM stdin;
\.
...
--
-- Data for Name: user_pvk_profession_result; Type: TABLE DATA; Schema: public; Owner: master
--

COPY public.user_pvk_profession_result (id, respondent_id, pvk_id, profession, criteria_list) FROM stdin;
\.
...
--
-- Name: lab_in_criteria_lab_for_criteria_id_seq; Type: SEQUENCE SET; Schema: public; Owner: master
--

SELECT pg_catalog.setval('public.lab_in_criteria_lab_for_criteria_id_seq', 1, false);
...
--
-- Name: user_pvk_profession_result_id_seq; Type: SEQUENCE SET; Schema: public; Owner: master
--

SELECT pg_catalog.setval('public.user_pvk_profession_result_id_seq', 1, false);
...
--
-- Name: lab_in_criteria lab_in_criteria_pkey; Type: CONSTRAINT; Schema: public; Owner: master
--

ALTER TABLE ONLY public.lab_in_criteria
    ADD CONSTRAINT lab_in_criteria_pkey PRIMARY KEY (lab_for_criteria_id);
...
--
-- Name: user_pvk_profession_result user_pvk_profession_result_pkey; Type: CONSTRAINT; Schema: public; Owner: master
--

ALTER TABLE ONLY public.user_pvk_profession_result
    ADD CONSTRAINT user_pvk_profession_result_pkey PRIMARY KEY (id);
