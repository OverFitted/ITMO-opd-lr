...
--
-- Name: presets lab_id_unique; Type: CONSTRAINT; Schema: public; Owner: master
--

ALTER TABLE ONLY public.presets
    ADD CONSTRAINT lab_id_unique UNIQUE (lab_id);
...
--
-- Name: presets fk_test_name; Type: FK CONSTRAINT; Schema: public; Owner: master
--

ALTER TABLE ONLY public.presets
    ADD CONSTRAINT fk_test_name FOREIGN KEY (lab_id, test_in_lab_id) REFERENCES public.test_name(lab_id, test_id);
