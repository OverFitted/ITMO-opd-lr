...
--
-- Name: lr2_results; Type: TABLE; Schema: public; Owner: master
--
...
ALTER TABLE public.lr2_results OWNER TO master;

--
-- Name: lr2_results_try_id_seq; Type: SEQUENCE; Schema: public; Owner: master
--
...
ALTER TABLE public.lr2_results_try_id_seq OWNER TO master;

--
-- Name: lr2_results_try_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: master
--
...
--
-- Name: lr3_results; Type: TABLE; Schema: public; Owner: master
--
...
ALTER TABLE public.lr3_results OWNER TO master;

--
-- Name: lr3_results_try_seq; Type: SEQUENCE; Schema: public; Owner: master
--
...
ALTER TABLE public.lr3_results_try_seq OWNER TO master;

--
-- Name: lr3_results_try_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: master
--
...
--
-- Name: lr2_results try_id; Type: DEFAULT; Schema: public; Owner: master
--
...
--
-- Name: lr3_results try; Type: DEFAULT; Schema: public; Owner: master
--
...
--
-- Data for Name: lr2_results; Type: TABLE DATA; Schema: public; Owner: master
--
...
--
-- Data for Name: lr3_results; Type: TABLE DATA; Schema: public; Owner: master
--
...
COPY public.users (usr_id, name, surname, usrname, passwd, gender, age, role) FROM stdin;
1	A	B	AB	ABA	M	10	\N
\.
...
--
-- Name: lr2_results_try_id_seq; Type: SEQUENCE SET; Schema: public; Owner: master
--
...
--
-- Name: lr3_results_try_seq; Type: SEQUENCE SET; Schema: public; Owner: master
--
...
--
-- Name: lr2_results lr2_results_pkey; Type: CONSTRAINT; Schema: public; Owner: master
--
...
--
-- Name: lr3_results lr3_results_pkey; Type: CONSTRAINT; Schema: public; Owner: master
--
...
--
-- Name: fki_fkey_params_list; Type: INDEX; Schema: public; Owner: master
--
...
--
-- Name: lr2_to_resp fkey_expert; Type: FK CONSTRAINT; Schema: public; Owner: master
--

ALTER TABLE ONLY public.lr2_to_resp
    ADD CONSTRAINT fkey_expert FOREIGN KEY (expert_id) REFERENCES public.experts(id) NOT VALID;


--
-- Name: lr3_to_resp fkey_expert; Type: FK CONSTRAINT; Schema: public; Owner: master
--
...
--
-- Name: lr2_to_resp fkey_params_list; Type: FK CONSTRAINT; Schema: public; Owner: master
--
...
ALTER TABLE ONLY public.lr2_to_resp
    ADD CONSTRAINT fkey_resp FOREIGN KEY (respondent_id) REFERENCES public.respondents(id) NOT VALID;
