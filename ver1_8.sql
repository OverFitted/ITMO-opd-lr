...
--
-- Name: params_list_lr4; Type: TABLE; Schema: public; Owner: master
--

CREATE TABLE public.params_list_lr4 (
    id integer NOT NULL,
    params_list integer[]
);


ALTER TABLE public.params_list_lr4 OWNER TO master;

--
-- Name: params_list_lr4_id_seq; Type: SEQUENCE; Schema: public; Owner: master
--

CREATE SEQUENCE public.params_list_lr4_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.params_list_lr4_id_seq OWNER TO master;

--
-- Name: params_list_lr4_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: master
--

ALTER SEQUENCE public.params_list_lr4_id_seq OWNED BY public.params_list_lr4.id;
...
--
-- Name: params_list_lr4 id; Type: DEFAULT; Schema: public; Owner: master
--

ALTER TABLE ONLY public.params_list_lr4 ALTER COLUMN id SET DEFAULT nextval('public.params_list_lr4_id_seq'::regclass);
...
COPY public.lr4_to_resp (id, respondent_id, expert_id, result_list_id_lr4, params_list_id_lr4) FROM stdin;
\.
...
--
-- Data for Name: params_list_lr4; Type: TABLE DATA; Schema: public; Owner: master
--

COPY public.params_list_lr4 (id, params_list) FROM stdin;
\.
...
COPY public.presets (preset_id, lab_id, test_in_lab_id, params) FROM stdin;
\.
...
--
-- Name: params_list_lr4_id_seq; Type: SEQUENCE SET; Schema: public; Owner: master
--

SELECT pg_catalog.setval('public.params_list_lr4_id_seq', 1, false);
...
--
-- Name: params_list_lr4 params_list_lr4_pkey; Type: CONSTRAINT; Schema: public; Owner: master
--

ALTER TABLE ONLY public.params_list_lr4
    ADD CONSTRAINT params_list_lr4_pkey PRIMARY KEY (id);
...
--
-- Name: lr4_to_resp lr4_to_resp_expert_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: master
--

ALTER TABLE ONLY public.lr4_to_resp
    ADD CONSTRAINT lr4_to_resp_expert_id_fkey FOREIGN KEY (expert_id) REFERENCES public.users(usr_id);


--
-- Name: lr4_to_resp lr4_to_resp_params_list_id_lr4_fkey; Type: FK CONSTRAINT; Schema: public; Owner: master
--

ALTER TABLE ONLY public.lr4_to_resp
    ADD CONSTRAINT lr4_to_resp_params_list_id_lr4_fkey FOREIGN KEY (params_list_id_lr4) REFERENCES public.params_list_lr4(id);
